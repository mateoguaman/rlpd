...
from rlpd.data import save_replay_buffer
...
MUJOCO_GL=egl XLA_PYTHON_CLIENT_PREALLOCATE=false python collect.py --env_name=HalfCheetah-v4  --save_dir ./expert_data --checkpoint_path=/home/mateo/projects/rlpd/logs/sac/2024-09-17_13-26-45/checkpoints --checkpoint_step=1000000 --config=configs/rlpd_config.py
'''